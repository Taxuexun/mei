...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=Url::toRoute('site/index')?>" class="logo">
      ...
      <span class="logo-mini"><b>M</b>ei</span>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user-menu notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="glyphicon glyphicon-user" style="font-size: 16px" alt=""></span>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <span class="glyphicon glyphicon-user" style="font-size: 50px">
          </span>
        </div>
